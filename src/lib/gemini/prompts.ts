export const SYSTEM_INSTRUCTION = `You are the AI host at the family celebration.
...
export const PROMPT_TEMPLATES: PromptTemplate[] = [
  ...
  },
  {
    ...
    buildPrompt: (_, scenario) =>
      `Based on all the family stories collected, who in the family is most likely to: ${scenario || "start a business, be late to every event, cook the best jollof rice"}? Use actual quotes and personality descriptions to justify your picks. Make it fun — the family should be pointing at each other and laughing.`,
  },
  {
    key: "legacy",
